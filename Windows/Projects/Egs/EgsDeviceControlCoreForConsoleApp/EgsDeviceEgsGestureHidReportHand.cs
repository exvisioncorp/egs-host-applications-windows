namespace Egs
{
    ...
    public class EgsDeviceEgsGestureHidReportHand : IHidReportForCursorViewModel
    {
        ...
        public int[] DetectionArea { get; internal set; }
        public bool IsTracking { get; internal set; }
        public int[] TrackingArea { get; internal set; }
        public int[] ScreenMappedArea { get; internal set; }
        ...
        internal void Reset()
        {
            ...
            Z = 0;
            FingerPitch = 0;
            DetectionArea = new int[4];
            TrackingArea = new int[4];
            ScreenMappedArea = new int[4];
            XScaleFactor = 1.0;
            YScaleFactor = 1.0;
        }
    }
