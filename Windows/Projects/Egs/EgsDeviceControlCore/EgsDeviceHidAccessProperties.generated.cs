namespace Egs
{
    ...
    public partial class EgsDevice
    {
        ...
        void CreateProperties()
        {
            ...
            HardwareType = new HidAccessPropertyOptional<HardwareTypeDetail>() { DescriptionKey = nameof(Resources.EgsDevice_HardwareType_Description), ReportId = 0x0B, MessageId = 0x00, CategoryId = 0x00, PropertyId = 0x1A, ValueTypeOnDevice = "byte", DataLength = 1, IsReadOnly = true, NameOfProperty = "HardwareType", AvailableFirmwareVersion = new Version("1.0") }; HardwareType.OptionalValue.Options = HardwareTypeDetail.GetDefaultList(); HardwareType.InitializeOnceAtStartup();
    ...
    public partial class EgsDeviceSettings
    {
        ...
        void CreateProperties()
        {
            ...
            PowerMode = new HidAccessPropertyOptional<PowerModeDetail>() { DescriptionKey = nameof(Resources.EgsDeviceSettings_PowerMode_Description), ReportId = 0x0B, MessageId = 0x00, CategoryId = 0x00, PropertyId = 0x2A, ValueTypeOnDevice = "byte", DataLength = 1, IsReadOnly = false, NameOfProperty = "PowerMode", AvailableFirmwareVersion = new Version("1.1.7907") }; PowerMode.OptionalValue.Options = PowerModeDetail.GetDefaultList(); PowerMode.InitializeOnceAtStartup();
            HostMachineOperatingSystem = new HidAccessPropertyOptional<HostMachineOperatingSystemDetail>() { DescriptionKey = nameof(Resources.EgsDeviceSettings_HostMachineOperatingSystem_Description), ReportId = 0x0B, MessageId = 0x00, CategoryId = 0x00, PropertyId = 0x30, ValueTypeOnDevice = "byte", DataLength = 1, IsReadOnly = false, NameOfProperty = "HostMachineOperatingSystem", AvailableFirmwareVersion = new Version("1.0") }; HostMachineOperatingSystem.OptionalValue.Options = HostMachineOperatingSystemDetail.GetDefaultList(); HostMachineOperatingSystem.InitializeOnceAtStartup();
            ...
            CaptureBinning = new HidAccessPropertyOptional<CaptureBinningDetail>() { DescriptionKey = nameof(Resources.EgsDeviceSettings_CaptureBinning_Description), ReportId = 0x0B, MessageId = 0x00, CategoryId = 0x20, PropertyId = 0x10, ValueTypeOnDevice = "byte", DataLength = 1, IsReadOnly = false, NameOfProperty = "CaptureBinning", AvailableFirmwareVersion = new Version("1.0") }; CaptureBinning.OptionalValue.Options = CaptureBinningDetail.GetDefaultList(); CaptureBinning.InitializeOnceAtStartup();
            ...
            LeftHandDetectionScaleOnFixed = new HidAccessPropertyRangedInt() { DescriptionKey = nameof(Resources.EgsDeviceSettings_LeftHandDetectionScaleOnFixed_Description), ReportId = 0x0B, MessageId = 0x00, CategoryId = 0x50, PropertyId = 0x31, ValueTypeOnDevice = "int", DataLength = 1, IsReadOnly = false, NameOfProperty = "LeftHandDetectionScaleOnFixed", AvailableFirmwareVersion = new Version("1.1.8109") }; LeftHandDetectionScaleOnFixed.InitializeOnceAtStartup();
            ...
            CursorSpeedAndPrecisionMode = new HidAccessPropertyOptional<CursorSpeedAndPrecisionModeDetail>() { DescriptionKey = nameof(Resources.EgsDeviceSettings_CursorSpeedAndPrecisionMode_Description), ReportId = 0x0B, MessageId = 0x00, CategoryId = 0xD0, PropertyId = 0x00, ValueTypeOnDevice = "byte", DataLength = 1, IsReadOnly = false, NameOfProperty = "CursorSpeedAndPrecisionMode", AvailableFirmwareVersion = new Version("1.0") }; CursorSpeedAndPrecisionMode.OptionalValue.Options = CursorSpeedAndPrecisionModeDetail.GetDefaultList(); CursorSpeedAndPrecisionMode.InitializeOnceAtStartup();
            FastMovingHandsGestureMode = new HidAccessPropertyOptional<FastMovingHandsGestureModeDetail>() { DescriptionKey = nameof(Resources.EgsDeviceSettings_FastMovingHandsGestureMode_Description), ReportId = 0x0B, MessageId = 0x00, CategoryId = 0xD0, PropertyId = 0x10, ValueTypeOnDevice = "byte", DataLength = 1, IsReadOnly = false, NameOfProperty = "FastMovingHandsGestureMode", AvailableFirmwareVersion = new Version("1.1.8005") }; FastMovingHandsGestureMode.OptionalValue.Options = FastMovingHandsGestureModeDetail.GetDefaultList(); FastMovingHandsGestureMode.InitializeOnceAtStartup();
